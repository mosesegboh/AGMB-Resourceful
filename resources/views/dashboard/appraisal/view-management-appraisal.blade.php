...
<div class="row">
    ...
    <div class="col-sm-12" style="border-bottom: 1px solid #eeeeee">
        <div class="form-group">
            <label>Management Decision</label>   
            <p class="form-control-static">
                {{$appraisal_forms->management_decision}}
            </p>
        </div>
    </div>
    ...
    <div class="col-sm-8">
        ...
        <div class="col-sm-12" style="padding:0;">
            <img src="{{url($appraisal_forms->manager_signature)}}" class="img img-responsive" style="border-bottom: 1px solid">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <p class="form-control-static">
                {{\Carbon\Carbon::parse($appraisal_forms->manager_date)->format('jS M, Y')}}
            </p>
        </div>
    </div>
</div>
