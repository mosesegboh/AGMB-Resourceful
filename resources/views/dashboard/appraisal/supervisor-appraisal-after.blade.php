...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="form-group">
            <p class="form-control-static" style="color:red; font-weight: bold;">The primary duties, performance areas, development plans, and evaluations have been discussed with me, I {{$appraisal_forms->appraisee_decision == 1 ? 'Agree' : 'Disagree'}} with the comments made</p>
        </div>
    </div>
    <hr>
...
<div class="row">
    ...
    <div class="col-sm-12" style="border-bottom: 1px solid #eeeeee">
        <div class="form-group form-number-textarea-padding" >
            <textarea name="supervisor_comment" class="form-control" placeholder="Supervisor Comment">{{old('supervisor_comment')}}</textarea>
        </div>
    </div>
	<hr>
	<div class="col-sm-8">
	...
	<div class="col-sm-4">
		...
		<div class="input-group date"  data-provide="datepicker" data-date-format="yyyy-mm-dd">
		    <input type="text" class="form-control" name="supervisor_date" placeholder="Supervisor Date"  value="{{old('supervisor_date')}}">
