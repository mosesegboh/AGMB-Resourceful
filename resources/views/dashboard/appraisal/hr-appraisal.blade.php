...
<div class="row">
    ...
    <div class="col-sm-12" style="border-bottom: 1px solid #eeeeee">
        <div class="form-group form-number-textarea-padding" >
            <textarea name="hr_comment" class="form-control" placeholder="Human Resources Comment">{{old('hr_comment')}}</textarea>
        </div>
    </div>
    <div class="col-sm-8">
    ...
    <div class="col-sm-4">
        ...
        <div class="input-group date"  data-provide="datepicker" data-date-format="yyyy-mm-dd">
            <input type="text" class="form-control" name="hr_date" placeholder="Human Resources Date"  value="{{old('hr_date')}}">
