...
<div class="row">
	<h4 class="appraisal-header">Section 1: QUANTITATIVE </h4>
...
<div class="row">
    ...
    <div class="col-sm-12" style="border-bottom: 1px solid #eeeeee">
        <div class="form-group">
            <label>Human Resources Comment</label>   
            <p class="form-control-static">
                {{$appraisal_forms->hr_comment}}
            </p>
        </div>
    </div>
    ...
    <div class="col-sm-8">
        <div class="col-sm-12">
            <strong>Human Resources Signature</strong>
        </div>
        <div class="col-sm-12" style="padding:0;">
            <img src="{{url($appraisal_forms->hr_signature)}}" class="img img-responsive" style="border-bottom: 1px solid">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <label>Human Resources Date</label>
            <p class="form-control-static">
                {{\Carbon\Carbon::parse($appraisal_forms->hr_date)->format('jS M, Y')}}
            </p>
        </div>
    </div>
</div>
...
{{csrf_field()}}
<input type="hidden" name="signature_png">
<div class="row">
    <hr>
    <div class="col-sm-12" style="border-bottom: 1px solid #eeeeee">
        <div class="form-group form-number-textarea-padding" >
            <textarea name="management_comment" class="form-control" placeholder="Management Decision">{{old('management_comment')}}</textarea>
        </div>
    </div>
    <div class="col-sm-8">
    ...
    <div class="col-sm-4">
        ...
        <div class="input-group date"  data-provide="datepicker" data-date-format="yyyy-mm-dd">
            <input type="text" class="form-control" name="management_date" placeholder="Human Resources Date"  value="{{old('management_date')}}">
